...
const BOTNAME = '🦋⃟•𝆺𝚪𝚯𝚭𝚫𝚪𝚰𝚯 𝐒𝚵𝚪☣☠︎︎';
const FOOTERNAME = '> ＶＡＪＩＲＡ -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '916282524515' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=OFMmGRbT#qA-ULO8Oq6sot8IgUmGbMx8nRW66h6fgIBsDv-l2rmE' ,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 🦋⃟•𝆺𝚪𝚯𝚭𝚫𝚪𝚰𝚯 𝐒𝚵𝚪☣☠︎︎ 👨‍💻',    
